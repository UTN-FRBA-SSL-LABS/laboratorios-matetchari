...
> R:Carrito_Init inicializa el carrito en 0, esto sirve para que no se inicialice con un valor basura
...
> R:Falla, espera 700 y recibe 350
...
> R:Esta en la linea 24. Dice: total += c->items[i].precio;

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R:Lo que deberia hacer es multiplicar correctamente por la cantidad
...
> R:Si, falla devolviendo un segmentation fault
...
> R:Si, las 29 y 30, No se ejecutaron porque ningun test llamo a la funcion carrito_descuento
...
> R:El unitario prueba una función; integración varias juntas. El de integración detectó el bug.
...
> R:C no controla límites del array; Python y Java sí.
...
> R:Los tests encuentran errores automáticamente y los dicen ahorrandonos la lectura manual.
...
> R:Esto es porque cantidad 1, multiplicar no cambia el precio
